...
def train():
    ...
    y_onehot = tf.keras.utils.to_categorical(y, 3) #labels=['normal', 'pneumonia', 'COVID-19']
...
def test():
    ...
    evaluation.confusion_matrix_info(y_test, np.argmax(y_pred, axis=1),title='confusion_matrix_test')
